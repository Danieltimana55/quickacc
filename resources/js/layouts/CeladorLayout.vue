    ...
    <div class="flex min-h-svh bg-gray-900 text-gray-300">
        ...
        <aside class="w-64 flex-shrink-0 bg-gray-800/60 p-6">
            <div class="flex flex-col gap-8">
                <Link :href="route('celador.dashboard')" class="flex flex-col items-center gap-2 font-medium">
                ...
                <nav class="flex flex-col gap-2">
                    <h2 class="text-lg font-semibold text-white">Celador</h2>
                    <!-- Navigation items will go here -->
                    <Link :href="route('celador.dashboard')" class="text-blue-400 hover:text-blue-300">
                        Dashboard
                    </Link>
                </nav>
            </div>
