...
<template>
    <div class="flex min-h-svh bg-gray-900 text-gray-300">
        <!-- Sidebar -->
        <aside class="w-64 flex-shrink-0 bg-gray-800/60 p-6">
            <div class="flex flex-col gap-8">
                <Link :href="route('instructor.dashboard')" class="flex flex-col items-center gap-2 font-medium">
                    <div class="mb-1 flex h-20 w-20 items-center justify-center rounded-full bg-gray-700/80 shadow-md p-1">
                ...
                <nav class="flex flex-col gap-2">
                    <h2 class="text-lg font-semibold text-white">Instructor</h2>
                    <!-- Navigation items will go here -->
                    <Link :href="route('instructor.dashboard')" class="text-blue-400 hover:text-blue-300">
                        Dashboard
                    </Link>
                </nav>
            </div>
