<template>
    ...
    <div class="w-full max-w-5xl mx-auto px-4 md:px-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            <h1 class="text-2xl md:text-3xl font-semibold text-white mb-4 sm:mb-0">Editar Usuario</h1>
            <Link 
        ...
        <form @submit.prevent="form.put(route('admin.users.update', user.id))" class="w-full">
            <div class="space-y-6 bg-gray-800/90 p-4 md:p-6 rounded-lg shadow-lg">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-300">
                        Contraseña <span class="text-gray-400">(Dejar en blanco para mantener la actual)</span>
                    </label>
                    <input
                        id="password"
                ...
                <div v-if="esAprendiz">
                    ...
                    <select
                        ...
                        :required="esAprendiz"
                    >
                        <option value="" disabled>Seleccione una formación</option>
...
const form = useForm({
    ...
    formacion_id: props.user.formacion_id,
});
...
const esAprendiz = computed(() => {
    ...
    return aprendizRol && Number(form.rol_id) === aprendizRol.id;
});
</script>