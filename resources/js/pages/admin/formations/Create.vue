<template>
    <Head title="Crear Formación" />
    <div class="w-full max-w-5xl mx-auto px-4 md:px-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            <h1 class="text-2xl md:text-3xl font-semibold text-white mb-4 sm:mb-0">Crear Formación</h1>
            <Link 
        ...
        <form @submit.prevent="form.post(route('admin.formations.store'))" class="w-full">
